...
ColumnLayout {
    ...
    signal loadPromptRequested(string text)
    ...
    RowLayout {
        ...
        Button {
            id: clearAllBtn
            visible: AppController.history.ttsHistory.length > 0
            implicitWidth: 64
            implicitHeight: 28
            flat: true
            ...
            onClicked: AppController.history.clearTtsHistory()
            HoverHandler { cursorShape: Qt.PointingHandCursor }
        }
    }
    ...
    Item {
        ...
        ListView {
            ...
            anchors.fill: parent
            visible: AppController.history.ttsHistory.length > 0
            model: AppController.history.ttsHistory
            spacing: Theme.paddingSmall
            clip: true
            ...
            delegate: Rectangle {
                ...
                property bool isCurrentlyPlaying: root.activePlayingPath === modelData.filePath
                ...
                MouseArea {
                    ...
                    onClicked: {
                        root.loadPromptRequested(modelData.text)
                    }
                }
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        ...
                        ColumnLayout {
                            ...
                            Text {
                                text: modelData.voiceName + " (" + modelData.modelName + ")"
                                color: Theme.textSecondary
                        ...
                        Button {
                            ...
                            onClicked: {
                                if (itemRect.isCurrentlyPlaying) {
                                    ...
                                    AppController.player.playFile(modelData.filePath)
                                }
                            }
                            HoverHandler { cursorShape: Qt.PointingHandCursor }
                        }
                        ...
                        Button {
                            ...
                            onClicked: {
                                ...
                                AppController.history.deleteTtsHistoryItem(modelData.id)
                            }
                            HoverHandler { cursorShape: Qt.PointingHandCursor }
                        }
                    }
