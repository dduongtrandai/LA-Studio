...
public:
    ...
    Q_INVOKABLE void transcribeSamples(const QVector<float> &samples, const QString &language = "en", int threads = 0, bool translate = false, const QVariantMap &settings = QVariantMap());
