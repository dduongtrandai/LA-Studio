...
class TtsEngineInstance : public QObject {
    Q_OBJECT
    QML_ELEMENT
    QML_UNCREATABLE("TtsEngineInstance is managed by TtsEngine")
...
public:
    ...
    explicit TtsEngineInstance(QObject *parent = nullptr);
    ~TtsEngineInstance() override;
